...
var apis = []api{
	...
	{"Stage 1", "vzeroupper (asm)", "VZEROUPPER", "AVX", archsimd.X86.AVX},
	// pkg.go.dev also documents archsimd.ClearAVXUpperBits() for the same purpose.
	...
	{"Bonus", "vzeroupper (asm)", "VZEROUPPER", "AVX", archsimd.X86.AVX},
